    ...
    <div className="pt-9 mb-[87px] px-5 md:px-10">
        <div className="max-w-[1200px] mx-auto">
                        ...
                        <tbody >
                           {shopData && shopData.map(item => (
                             <tr key={item._id}>
                                ...
                                <td className="text-[#46A358] text-[20px] leading-[16px] font-[700]">${((item.price * 1000) * item.count) / 1000}</td>
                                <td>
            ...
            <div className="my-[128px]">
                ...
                <hr />
                <ReletedProductsData flowerReletedData={productsData?.products}/>
            </div>
        </div>
    </div>
  )
